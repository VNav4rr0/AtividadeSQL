...
<button type="submit" class="btn btn-primary d-flex align-items-center justify-content-between ps-4 pe-3">Cadastrar <span class="material-symbols-outlined ps-1 pe-2">
done
</span></button>
</div>
    </form>
